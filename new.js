...
alert('Вопрос 3. * Чему будет равно JS-выражение 1000 + "108"?');

var a = 1000 + "108";
alert('JS-выражение 1000 + "108" равно ' + a +
    '\nчисло 1000 переведено в строковый тип и произведена конкатенация строк');


alert('Вопрос 4. * Самостоятельно разобраться с атрибутами тега script (async и defer).');

alert('Вроде разобрался');
...
В целом и общем понятно, но пока не понятно что такое DOMContentLoaded.
Надеюсь мы коснемся этих вопросов в процессе обучения. */
